...
var score = 0;
var levelCounter = 1; // Initialize the counter

// Initialize the board with unmovable pieces
function initBoard(levelCounter) {
    ...
    updateInfoPanel(randomOrientation, currentMode.mode, "Enter the notation for the " + randomPieceColor + " piece");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('currentLevel').innerText = `Level ${levelCounter}:`;
...
function updateInfoPanel(orientation, level, prompt) {
    ...
    document.getElementById('currentMode').innerText = level;
...
function validateUserInput(input) {
    ...
    switch (currentMode.mode) {
        case 'full':
            isValid = validateFullNotation(input);
            break;
        default:
